...
class EntityDataPersister implements DataPersisterInterface
{
    ...
    {
        if ($data instanceof User  || $data instanceof GroupeTags  || $data instanceof Groupecompetence || $data instanceof Niveau || $data instanceof Referentiel || $data instanceof ProfilSortie)
        {
            return true;
        }
        return false;
