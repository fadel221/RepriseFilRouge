 ...
 */
final class Version20210122173632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE promo DROP referentiel_id, CHANGE date_début date_début DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE promo ADD referentiel_id INT DEFAULT NULL, CHANGE date_début date_début DATE NOT NULL');
